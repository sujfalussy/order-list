...
console.log("env integrationId: " + integrationId);
console.log("env appId: " + appId);
...
async function webviewSubmissionHandler(req, res) {
  ...
  try {
    ...
    messagePost.setAuthor({ type: "business", displayName: "Order Assistant", avatarUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/3/37/Just_Eat_Takeaway.com_icon_logo.svg/1200px-Just_Eat_Takeaway.com_icon_logo.svg.png" });
